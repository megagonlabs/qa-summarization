...
|-----|---------------------|----------|------------------------|----------------------------------------------------------|---------|
| 1 | CoQASUM dataset | No  |  | [source](https://github.com/megagonlabs/qa-summarization) generated from [Amazon question/answer data](https://cseweb.ucsd.edu/~jmcauley/datasets/amazon/qa/) | |
