...
# map train data
qa_summary_train = qa_summary_train.map(
    process_data_to_model_inputs,
    batched=True,
    batch_size=batch_size,
    remove_columns=["qa_pairs_text", "summary"]
)

# map val data
qa_summary_val = qa_summary_val.map(
    process_data_to_model_inputs,
    batched=True,
    batch_size=batch_size,
    remove_columns=["qa_pairs_text", "summary"]
...
qa_summary_train.set_format(
    type="torch",
    columns=["input_ids", "attention_mask", "global_attention_mask", "labels"],
)

# set Python list to PyTorch tensor
qa_summary_val.set_format(
    type="torch",
    columns=["input_ids", "attention_mask", "global_attention_mask", "labels"],
)
...
trainer = Seq2SeqTrainer(
    ...
    train_dataset=qa_summary_train,
    eval_dataset=qa_summary_val,
)
