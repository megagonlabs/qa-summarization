...
class QASumPreSplitDataModule(LightningDataModule):
    def __init__(self,
        ...
        assert os.path.exists(valid_json_filepath)
        ...
        self.valid_json_filepath = train_json_filepath
        self.test_json_filepath = train_json_filepath
...
if __name__ == "__main__":
    ...
    dm = QASumPreSplitDataModule(tokenizer)
    dm.prepare_data()
